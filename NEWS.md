...
* graph,graphql,store: nested sorting by @kamilkisiela in https://github.com/graphprotocol/graph-node/pull/3096
* build(deps): bump uuid from 0.8.2 to 1.2.2 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4366
* store: Do not intercept error from layout.delete by @lutter in https://github.com/graphprotocol/graph-node/pull/4367
* Fix limit handling on rpc configuration by @mangas in https://github.com/graphprotocol/graph-node/pull/4353
* tests: Make running createdb more tolerant to slow Postgres startup by @lutter in https://github.com/graphprotocol/graph-node/pull/4376
* Refactor firehose/rpc decision to happen earlier in the flow by @mangas in https://github.com/graphprotocol/graph-node/pull/4375
* build(deps): bump uuid from 1.2.2 to 1.3.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4388
* build(deps): bump petgraph from 0.6.2 to 0.6.3 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4386
* build(deps): bump tokio-stream from 0.1.11 to 0.1.12 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4384
* build(deps): bump async-stream from 0.3.3 to 0.3.4 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4385
* Solve some clippy warnings by @shyba in https://github.com/graphprotocol/graph-node/pull/4349
* Enforce Clippy in the CI by @neysofu in https://github.com/graphprotocol/graph-node/pull/4389
* chain: Ignore a latest block that would make us go back by @lutter in https://github.com/graphprotocol/graph-node/pull/4354
* `v0.30.0` release notes by @neysofu in https://github.com/graphprotocol/graph-node/pull/4363
* Implement moving of subgraphs by @lutter in https://github.com/graphprotocol/graph-node/pull/4374
* Delete dead code in `aggregate.rs` by @neysofu in https://github.com/graphprotocol/graph-node/pull/4392
* Remove unused env. vars. by @neysofu in https://github.com/graphprotocol/graph-node/pull/4393
* store: Tolerate a missing source for a copy by @lutter in https://github.com/graphprotocol/graph-node/pull/4396
* all: Make `graphman chain call-cache remove` safer by @lutter in https://github.com/graphprotocol/graph-node/pull/4397
* Improve running subgraph metric accuracy by @mangas in https://github.com/graphprotocol/graph-node/pull/4398
* all: Indicate whether to only locate active deployment by @lutter in https://github.com/graphprotocol/graph-node/pull/4395
* Add a flag to graphman to list all deployments by @incrypto32 in https://github.com/graphprotocol/graph-node/pull/4347
* Improve subgraph running count metrics by @mangas in https://github.com/graphprotocol/graph-node/pull/4401
* build(deps): bump prost from 0.11.6 to 0.11.8 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4405
* build(deps): bump tower-test from `74881d5` to `664cb35` by @dependabot in https://github.com/graphprotocol/graph-node/pull/4403
* build(deps): bump prost-types from 0.11.6 to 0.11.8 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4404
* add protobuf-compiler to prerequisites by @flametuner in https://github.com/graphprotocol/graph-node/pull/4410
* store: Remove ability to recount entities by @lutter in https://github.com/graphprotocol/graph-node/pull/4406
* `BlockchainBuilder` abstraction to simplify instantiating chains by @neysofu in https://github.com/graphprotocol/graph-node/pull/4408
* Remove unused `FromStr` implementation in `capabilities.rs` by @neysofu in https://github.com/graphprotocol/graph-node/pull/4423
* `EmptyRuntimeAdapter` to reduce code duplication and simplify adding support for new chains. by @neysofu in https://github.com/graphprotocol/graph-node/pull/4424
* graph: fix backoff overflow by @YaroShkvorets in https://github.com/graphprotocol/graph-node/pull/4421
* node, store: Warn if reassigning to a new node by @lutter in https://github.com/graphprotocol/graph-node/pull/4377
* Small logging tweaks by @lutter in https://github.com/graphprotocol/graph-node/pull/4399
* Further refactor adapter handling, BlockStream, BlockIngestor by @mangas in https://github.com/graphprotocol/graph-node/pull/4411
* Remove two unneeded feature flags by @lutter in https://github.com/graphprotocol/graph-node/pull/4436
* Remove `MockMetricsRegistry` in favor of the real one by @neysofu in https://github.com/graphprotocol/graph-node/pull/4427
* Refactor some code in Cosmos' `trigger.rs` by @neysofu in https://github.com/graphprotocol/graph-node/pull/4426
* graph: Add endpoint metrics by @mangas in https://github.com/graphprotocol/graph-node/pull/4430
* store: Treat 'no connection to the server' as db not available by @lutter in https://github.com/graphprotocol/graph-node/pull/4435
* Add facilities to gte more details during indexing by @lutter in https://github.com/graphprotocol/graph-node/pull/4445
* Codespaces by @flametuner in https://github.com/graphprotocol/graph-node/pull/4444
* Fulltext filter by @flametuner in https://github.com/graphprotocol/graph-node/pull/4442
* Remove unfinished schema composition by @lutter in https://github.com/graphprotocol/graph-node/pull/4457
* Remove some cyclic crate dependencies by @lutter in https://github.com/graphprotocol/graph-node/pull/4448
* Automatically refresh materialized views by @lutter in https://github.com/graphprotocol/graph-node/pull/4461
* NEWS.md: Add a note about filtering fulltext searches by @lutter in https://github.com/graphprotocol/graph-node/pull/4464
* build(deps): bump chrono from 0.4.23 to 0.4.24 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4450
* Instrument `RecentBlocksCache` with metrics by @neysofu in https://github.com/graphprotocol/graph-node/pull/4440
* build(deps): bump crossbeam-channel from 0.5.5 to 0.5.7 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4428
* Make `MetricsRegistry` uncloneable by @neysofu in https://github.com/graphprotocol/graph-node/pull/4472
* graph: fix substreams `startBlock` selection by @YaroShkvorets in https://github.com/graphprotocol/graph-node/pull/4463
* Remove some unused lazy statics in `prefetch.rs` by @neysofu in https://github.com/graphprotocol/graph-node/pull/4473
* graph: Remove unneeded From<Entity> implementations by @lutter in https://github.com/graphprotocol/graph-node/pull/4465
* Use GitHub issue forms by @neysofu in https://github.com/graphprotocol/graph-node/pull/4469
* Remove `MetricsRegistryTrait` and use just `struct MetricsRegistry` by @neysofu in https://github.com/graphprotocol/graph-node/pull/4470
* Add jitter to `ExponentialBackoff` by @YaroShkvorets in https://github.com/graphprotocol/graph-node/pull/4476
* Upgrade to Rust 1.68.0 by @neysofu in https://github.com/graphprotocol/graph-node/pull/4471
* Do not use `GRAPH_LOG` to set log level for `graphman` by @lutter in https://github.com/graphprotocol/graph-node/pull/4462
* docs: Mention the defaults for GraphQL validation settings by @lutter in https://github.com/graphprotocol/graph-node/pull/4478
* build(deps): bump openssl from 0.10.45 to 0.10.47 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4481
* build(deps): bump anyhow from 1.0.69 to 1.0.70 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4479
* Detect timeouts in asc_type_id by @leoyvens in https://github.com/graphprotocol/graph-node/pull/4475
* store: Disable collecting write metrics for synced deployments by @lutter in https://github.com/graphprotocol/graph-node/pull/4489
* build(deps): bump openssl from 0.10.47 to 0.10.48 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4493
* Fix Markdown rendering in issue templates by @neysofu in https://github.com/graphprotocol/graph-node/pull/4495
* graph: Add new counter to EndpointMetrics by @mangas in https://github.com/graphprotocol/graph-node/pull/4490
* Ongoing pruning by @lutter in https://github.com/graphprotocol/graph-node/pull/4429
* Ensure `earliest_block` on copies is set correctly by @lutter in https://github.com/graphprotocol/graph-node/pull/4502
* graph-chain-ethereum: Avoid adapters with errors by @mangas in https://github.com/graphprotocol/graph-node/pull/4468
* chain/ethereum: Use provider for metrics by @mangas in https://github.com/graphprotocol/graph-node/pull/4504
* build(deps): bump quote from 1.0.23 to 1.0.26 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4501
* build(deps): bump tower-test from `664cb35` to `d2f1703` by @dependabot in https://github.com/graphprotocol/graph-node/pull/4498
* build(deps): bump shellexpand from 2.1.0 to 3.1.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4497
* build(deps): bump indexmap from 1.9.2 to 1.9.3 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4499
* Derived fields getter by @flametuner in https://github.com/graphprotocol/graph-node/pull/4434
* Docs for pruning and some internal renaming by @lutter in https://github.com/graphprotocol/graph-node/pull/4505
* chain/ethereum: RuntimeAdapter lazy EthAdapter by @mangas in https://github.com/graphprotocol/graph-node/pull/4508
* Restructure integration tests to make rust-analyzer happy by @lutter in https://github.com/graphprotocol/graph-node/pull/4510
* graph, test-store: Small improvements by @lutter in https://github.com/graphprotocol/graph-node/pull/4530
* Fix: typos by @omahs in https://github.com/graphprotocol/graph-node/pull/4523
* build(deps): bump h2 from 0.3.13 to 0.3.17 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4537
* chain/ethereum: Add provider string to logger on eth_call by @mangas in https://github.com/graphprotocol/graph-node/pull/4548
* graph, store: Remove SqlValue, implement ToSql directly for Value by @lutter in https://github.com/graphprotocol/graph-node/pull/4549
* node: Fix fresh start with firehose only by @mangas in https://github.com/graphprotocol/graph-node/pull/4553
* core: Add more stopwatch sections to runner process by @mangas in https://github.com/graphprotocol/graph-node/pull/4558
* build(deps): bump tokio from 1.26.0 to 1.27.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4512
* build(deps): bump hex-literal from 0.3.4 to 0.4.1 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4526
* build(deps): bump env_logger from 0.9.3 to 0.10.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4518
* build(deps): bump openssl from 0.10.48 to 0.10.50 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4528
* build(deps): bump proc-macro2 from 1.0.54 to 1.0.56 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4513
* build(deps): bump prost from 0.11.8 to 0.11.9 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4550
* build(deps): bump async-recursion from 1.0.0 to 1.0.4 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4516
* build(deps): bump uuid from 1.3.0 to 1.3.1 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4527
* core, graph, runtime: Add store.get_in_block by @lutter in https://github.com/graphprotocol/graph-node/pull/4540
* core: Log how many entries the cache had at each block by @lutter in https://github.com/graphprotocol/graph-node/pull/4541
* graph: Use a map with interned keys for `Entity` by @lutter in https://github.com/graphprotocol/graph-node/pull/4485
* Avoid `writer poisoned` errors by @lutter in https://github.com/graphprotocol/graph-node/pull/4533
* core, graph: Log more details about the entity cache by @lutter in https://github.com/graphprotocol/graph-node/pull/4571
* ipfs: Remove concurrency limit, rely on rate limit by @leoyvens in https://github.com/graphprotocol/graph-node/pull/4570
* json-rpc: Add history_blocks as parameter to create_subgraph_version by @mangas in https://github.com/graphprotocol/graph-node/pull/4564
* Limit stack depth of asc_get by @leoyvens in https://github.com/graphprotocol/graph-node/pull/4576

## New Contributors
* @shyba made their first contribution in https://github.com/graphprotocol/graph-node/pull/4349
* @incrypto32 made their first contribution in https://github.com/graphprotocol/graph-node/pull/4347
* @flametuner made their first contribution in https://github.com/graphprotocol/graph-node/pull/4410
* @YaroShkvorets made their first contribution in https://github.com/graphprotocol/graph-node/pull/4421
